...
import com.hhhh.scancode_master.R;
...
public class QrConfig implements Serializable {
    ...
    public  int CORNER_COLOR = Color.parseColor("#ff5f00");//线框角的颜色
    public  int LINE_COLOR = Color.parseColor("#ff5f00");//线的颜色

    public  int TITLE_BACKGROUND_COLOR = Color.parseColor("#ff5f00");//标题栏背景颜色
    public  int TITLE_TEXT_COLOR = Color.parseColor("#ffffff");//标题的字体颜色

    public boolean show_title = true;//标题是否展示
    ...
    public String title_text = "请扫描二维码";
