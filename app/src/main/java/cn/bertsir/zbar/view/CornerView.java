...
public class CornerView extends View {
    ...
    public CornerView(Context context, @Nullable AttributeSet attrs) {
        ...
        cornerColor = a.getColor(R.styleable.CornerView_corner_color, getResources().getColor(R.color.greeny));
        cornerWidth = (int) a.getDimension(R.styleable.CornerView_corner_width,10);
        cornerGravity = a.getInt(R.styleable.CornerView_corner_gravity, 2);
        a.recycle();
